...
import { backgroundHeight, opacity } from "./animation";
      ...
      <div className={styles.header}>
        <div className={styles.headerMain}>
          <div className={styles.headerMainLeft}>
            <a href="https://i.pinimg.com/736x/bd/60/20/bd602038f89040b5940a74929db501af.jpg">
              Jenn
            </a>
          </div>
          ...
          >
            <div
              ...
              ${isNavOpen && styles.hamburgerCrossed}`}
            >
              <span></span>
              <span></span>
            </div>
          ...
          >
            <div className={styles.shopLabel}>
              <a href="https://i.pinimg.com/564x/c6/89/19/c68919602457eafd616bd1c1594da1e3.jpg">
                Shop
              </a>
            </div>
